...
router.get("/partidos/:id", partido_controller.get_partido_by_id);

router.post("/:idTorneo/partidos", isLoggedIn, partido_controller.create_partido);
router.put("/partidos/:id", isLoggedIn, partido_controller.update_partido);
router.delete("/partidos/:id", isLoggedIn, partido_controller.delete_partido);
